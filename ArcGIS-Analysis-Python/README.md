...
1. src folder - This folder contains the current and past versions of Python scripts for generating the interpolated biomass and calculating the distribution indicators (latitude, depth, range limits, etc). 
